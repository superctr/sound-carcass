 ...
 *
 * Draws the SC-88Pro's panel from the baked artwork (gui/panel_layout.h,
...
/* One panel per size; `pitch` is the glass's dot pitch in pixels, one of
 * the baked sizes (4, or 8 for twice the size).  NULL if there is no such
 * bake or the artwork does not decode. */
